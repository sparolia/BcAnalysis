...
do
  ...
  then
    ...
    cd "${dirName}_${i}"
    sed -i 's/XXX_NAME_XXX/RJPsiNormalizationAnalysisOldSample/g' crabConfiguration.py
    sed -i 's/XXX_INPUTFILES_XXX/files_jpsi_munu/g' crabConfiguration.py
    sed -i 's/XXX_NJOBS_XXX/16/g' crabConfiguration.py
    sed -i 's/XXX_UNITSPERJOB_XXX/10/g' crabConfiguration.py
    sed -i "s/XXX_INPUTDATASET_XXX/'\/BcJpsiMuNu_020519\/cgalloni-Fall18_10_2_9-MINIAODSIM_noDuplCheck-092bfc61e82f18935ea11e32077a486f\/USER'/g" crabConfiguration.py
